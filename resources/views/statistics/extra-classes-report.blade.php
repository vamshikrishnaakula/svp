...
<section id="grades" class="content-wrapper_sub">
    <div class="user_manage">
        ...
        <form id="extra_class_report_form" autocomplete="off">
            ...
            <div class="d-flex justify-content-end report_submit_btn">
                <a class="pt-1" onclick="window.download_extraClass_report();"><img src="{{ asset('images/download1.png') }}" width="25" /></a>
            </div>

            <div id="extra_class_report_status" class="mt-3"></div>
        </form>
