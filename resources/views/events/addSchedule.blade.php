...
<script src="https://cdn.datatables.net/1.11.3/js/dataTables.bootstrap4.min.js"></script>
    ...
    <section id="event" class="content-wrapper_sub">
      ...
      <!--   <div class="row">
        ...
        <?php
        //$date = date('d/m/Y h:i a', $check_event_scheduler->date);
       // print_r($date);exit;
         ?>
        <div class="row my-3">
            <div class="col-md-12">
             ...
             <form id="scheduler_submit_form" name="scheduler_submit_form" autocomplete="off" method="POST">
                    <div class="d-flex align-items-center time_Sec">
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="round" />
                            <input type="hidden" class="form-control form-control-sm" name="event_id"  value= "{{ $event->id }}"/>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="input-group" id="datetimepicker_schedule" data-target-input="nearest">
                                <input type="text" class="form-control reqField"
                                    data-target="#datetimepicker_schedule"  data-toggle="datetimepicker" id="datetimepicker_schedule" name="venue_Time" autocomplete="off" required/>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="probationers_table" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                               <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input bulk-action-cb" id="bulkActionCb-{{$probationer->id}}" data-probationer-id="{{$probationer->id}}">
     ...
     * ----------------------------------------------------------------- */
     if (!window.scheduler_formsubmit) {
        window.scheduler_formsubmit = function() {
            ...
            var actionUrl = appUrl + "/events/scheduler";
            if (isValid == true) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    setTimeout(function(){
                        window.location.href = appUrl + "/eventSchedule";
                   }, 2000);
                }
            });
        }
