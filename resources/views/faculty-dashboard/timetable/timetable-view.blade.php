...
<section id="viewtimetable" class="content-wrapper_sub">
    <div class="user_manage">
        ...
        <form name="get_timetableView_form" id="get_timetableView_form" action="{{ url('timetables/ajax') }}" method="post" class="" accept-charset="utf-8">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <input type="text" name="from_date" id="from_date" class="form-control datePicker" autocomplete="off" />
                    </div>
                </div>
                <div class="col-md-6">
                    <label>Date (To):</label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="usersubmitBtns mt-4">
                        <div class="mr-4">
                            <button type="button" onclick="window.get_timetableView();" class="btn formBtn submitBtn">Proceed</button>
                        </div>
                    </div>
                </div>
            </div>
