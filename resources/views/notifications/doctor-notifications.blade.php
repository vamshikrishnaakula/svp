            ...
            <div class="notifications-wrapper">
                ...
                if($userData->role === 'probationer') {
                    ...
                    $NF_query->whereRaw("
                        ...
                        AND
                        (squad_id IS NULL OR squad_id IN ('', '0', $pb_data->squad_id))
                    ");
                } elseif( in_array($userData->role, ['doctor', 'drillinspector']) ) {
                    $NF_query->whereRaw("recipient_type IS NULL OR recipient_type IN ('', '0', '{$userData->role}')");
                }

                $Notifications  = $NF_query->orderBy('id', 'desc')->get();
                ?>
