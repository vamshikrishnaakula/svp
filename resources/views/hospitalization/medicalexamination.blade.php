        ...
        <div class="user_manage">
            ...
            <div class="mt-4">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#viewrecords">View
                            Records</a></li>
                </ul>
            </div>
            ...
            <div class="tab-content p-5">
                <div id="addnew" class="tab-pane fade in active show">
                    <form id="get_prob_details" name="get_prob_details" style="width: 70%; margin: 0 auto">
                        <div class="row">
                            ...
                            <a onclick="get_prob_data()"><img src="{{ asset('images/submit.png') }}" /></a>
                        </div> --}}

                            <div class="rollnosubmit col-md-3">
                                <button type="submit" class="btn btn-img"><img
                                        src="{{ asset('images/submit.png') }}" /></button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form id="medical_examination">
                        <div class="row profileInfo mt-5">
                            ...
                            <div class="col-md-3">
                                <div class="input-group" id="insert_datetimepicker" data-target-input="nearest"
                                    name="Dob">
                                    <input type="text" class="form-control datetimepicker-input"
                                        data-target="#insert_datetimepicker" data-toggle="datetimepicker" name="date"
                                        id="month_datepicker" autocomplete="off" required />
                                </div>
                            </div>
                        </div>
                ...
                <div id="viewrecords" class="tab-pane fade in">
                    <form style="width: 70%; margin: 0 auto" autocomplete="off" id="viewmedicalrecords"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Month :</label>
                                    <div class="input-group" id="medical_datetimepicker" data-target-input="nearest"
                                        name="Dob">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#medical_datetimepicker" data-toggle="datetimepicker" name="Dob"
                                            id="month_datepicker1" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2" style="align-self: center; margin-top: 15px;">
                                <div class="usersubmitBtns">
                                    ...
                                    <a class="pl-2 pt-1" onclick="downloadmedical()"><img
                                            src="{{ asset('images/download1.png') }}" width="25"></a>
                                </div>
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data != '') {
                        ...
                        $('#error').empty();
                        var e = $(
                            '<div class="alert alert-danger"><p>Please Enter valid Probationer RollNumber</p></div>'
                            );
                        $('#error').append(e);
                ...
                $.ajax({
                    ...
                    success: function(rData) {
                        ...
                        if (rObj.status !== 'success') {
                            ...
                            $('#pre_existing, #covid, #temperature, #antigen, #rtpcr, #hemoglobin, #calcium, #vitamind, #vitaminb12')
                                .text('');
                            $("#no_data_alert").html(
                                '<p class="text-danger mb-0" style="margin:30px 0 -30px !important;">' +
                                rObj.message + '.</p>')
                        } else {
