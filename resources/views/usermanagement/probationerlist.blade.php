...
<section id="probationerlist" class="content-wrapper_sub tab-content">
            <div class="user_manage">
                <div class="row">
                    <div class="col-md-6">
                      <h4>Probationers List</h4>
                    </div>
                      ...
                      <table class="table">
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td>gerger</td>
                                  <td>34636363</td>
                                  <td><a href="./probationerprofile.html"><img src="./images/view.png" /><span>View</span></a></td>
                                  <td><a href="./editprobationer.html"><img src="./images/edit.png" /><span>Edit</span></a></td>
                              </tr>
                              <tr>
                                <td><input type="checkbox" class="form-control" /></td>
                                <td>gretrhr</td>
                                ...
                                <td>gerger</td>
                                <td>34636363</td>
                                <td><a href="#"><img src="./images/view.png" /><span>View</span></a></td>
